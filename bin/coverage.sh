...
$jruby_path -J-Xmx63G -S rake coverage:ddb DDB_DATA_PATH=$idp2_prefix/svn/idp.data/DDB_EpiDoc_XML/ SAMPLE_FRAGMENTS=10 HTML_OUTPUT=$idp2_prefix/coverage/$today.html &>> $idp2_prefix/coverage/$today.txt
